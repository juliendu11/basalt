...
/**
 * No email-specific role: standard project permission matrix
 * (docs/plans/19-security.md § Matrice de permissions standard "projet") —
 * owner/admin/member can create/edit/delete/publish, viewer is read-only.
 * Mirrors `ContactPolicy`/`EmailTemplatePolicy`.
 */
